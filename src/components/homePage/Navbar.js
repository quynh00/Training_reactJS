    ...
    <div className={checkTheme === "dark" ? "dark-menu" : "light-menu"}>
      ...
      <ul className="primary">
        <div className="search-box">
          <div className="input-box">
            <input
              type="text"
              placeholder={t("nav.input-search")}
        ...
        <li className="tabWatchList ">
          <a title={t("nav.fl-list")} className="fl-list">
            {t("nav.fl-list")}
            <VscTriangleDown />
          </a>
        </li>
        <li className="sub-menu item">
          <a
            title={t("nav.hose")}
            className={table === "HOSE" ? "fl-list-active" : "fl-list"}
            onClick={tableHOSE}
          >
            {tabName}
            <VscTriangleDown />
          ...
          <ul className="sub-menu-item">
            <li
              className={
                table === "HOSE" ? "sub-menu-list-active" : "sub-menu-list"
              }
              onClick={tableHOSE}
            >
              <a>
            ...
            <li
              className={
                table === "VN30" ? "sub-menu-list-active" : "sub-menu-list"
              }
              onClick={tableVN30}
            >
              <a>
        ...
        <li className="sub-menu item">
          <a
            title={t("nav.HNX_title")}
            className={table === "HNX" ? "fl-list-active" : "fl-list"}
            onClick={tableHNX}
          >
            HNX
            <VscTriangleDown />
          ...
          <ul className="sub-menu-item">
            <li
              className={
                table === "HNX" ? "sub-menu-list-active" : "sub-menu-list"
              }
              onClick={tableHNX}
            >
              <a>
        ...
        <li className="sub-menu ">
          <a
            title={t("nav.Upcom_title")}
            className={table === "UPCOM" ? "fl-list-active" : "fl-list"}
            onClick={tableUPCOM}
          >
            UPCOM
            <VscTriangleDown />
        ...
        <li className="sub-menu ">
          <a className="fl-list">
            {t("nav.odd-lot")} <VscTriangleDown className="arrow-down" />
          </a>
        </li>
      </ul>
      ...
      <ul className="primary">
        <li className={setActiveIcon()} onClick={OnSlide}>
          <a title={t("navbar.slide_show")} className="icon-secondary">
            <BsFillCameraVideoFill />
          </a>
        </li>

        <li className="icon-toggle2" onClick={() => setShow(!show)}>
          <a title={t("navbar.hideshow_chart")} className="icon-secondary">

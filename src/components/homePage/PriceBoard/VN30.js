...
import vn30_instruments from '../../../dataFile/priceboard/vn30_instruments.json';
...
function HNX() {   
    ...
    let get20Data = vn30_instruments.d.slice(0, 20) 
  ...
  //random các ô 
    ...
    const tableVN30 = vn30_instruments.d.map((info) => {
